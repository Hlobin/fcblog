package com.feicheng.blog.utils;
...
public class RandomValidateCode {
    ...
    // 校验验证码是否正确
    public static boolean verify(HttpServletRequest request, String captcha) {
        ...
        // 获取验证码
        String code = (String) request.getSession().getAttribute(RANDOMCODEKEY);

        // 若校验不通过
        if (!StringUtils.equalsAnyIgnoreCase(captcha, code)) {
